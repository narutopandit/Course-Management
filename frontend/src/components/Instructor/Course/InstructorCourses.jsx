...
import { GetCoursesApi } from "../../../Services/CourseServices/courseApi";

const GetAllCourseIns = () => {
  ...
  const newData = data.filter((e)=>e?.user[0]?.username===user);
    ...
    <div className="container mx-auto p-8 bg-gray-200">
      <div className="text-center mb-10">
        ...
        <p className="text-lg text-gray-700">
          Select a course and start keeping
...
export default GetAllCourseIns;