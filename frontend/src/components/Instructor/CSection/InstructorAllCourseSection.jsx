...
import { deleteSectionAPI, getAllCourseSectionsAPI } from "../../../Services/CSectionServices/CsectionApi";

const InstructorAllCourseSections = () => {
...
export default InstructorAllCourseSections;