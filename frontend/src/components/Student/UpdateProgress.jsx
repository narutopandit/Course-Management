...
import { getUserProfileAPI } from "../../Services/UserServices/userApi";
import { updateProgressAPI } from "../../Services/CSectionServices/CsectionApi";
...
const ProgressUpdate = () => {
  ...
  const ongoingSections = data?.progressCourse?.sections;

  //get ongoing course
  const ongoingCourse = data?.progressCourse?.courseId;
