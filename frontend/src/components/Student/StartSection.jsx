...
import { startSectionAPI } from "../../Services/CSectionServices/CsectionApi";
...
//   console.log("data", data?.progressCourse);

  //get the sections

  const courseSections = data?.progressCourse?.courseId?.sections
